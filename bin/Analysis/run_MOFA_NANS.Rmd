...
```{r}
select_samples <- phenotype_data[phenotype_data$phenotype %in% c('Healthy', 'Diseased: NANS-CDG'),]
...
outdir <- params$outdir
outfile = file.path(outdir, "model_NANS.hdf5")
...
lapply(assay_names, function(a) {
  ...
  f <- gsub("[| ,]", "_", a)
  outdur_disease <- file.path(outdir, 'NANS')
